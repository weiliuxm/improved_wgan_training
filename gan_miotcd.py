#generate 64*64 samples for miotcd dataset
import os, sys
...
import tflib.small_miotcd
import tflib.ops.layernorm
import tflib.plot

# Download 64x64 ImageNet at http://image-net.org/small/download.php and
# fill in the path to the extracted files here!
# DATA_DIR = '/media/weiliu/data/imageNet/'
DATA_DIR = '/media/weiliu/data/MIOTCD/MIO-TCD-Classification/train'
if len(DATA_DIR) == 0:
...
ITERS = 200 # How many iterations to train for
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    # Dataset iterator
    train_gen, dev_gen = lib.small_miotcd.load(BATCH_SIZE, data_dir=DATA_DIR)
